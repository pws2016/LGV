...
<html lang="it">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title><?php echo lang('app.title_page_patient_new')?> | <?php echo $settings['meta_title']?></title>
...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
 <link rel="stylesheet" href="<?php echo base_url()?>/Minible_v2.0.0/Admin/dist/assets/libs/multiselect-master/lib/google-code-prettify/prettify.css" />
    ...
    <body data-sidebar="dark">
		...
		echo form_open_multipart( base_url($prefix_route.'/patients/new'), $attributes);?>
