...
<html lang="it">
    <head>
        <meta charset="utf-8" />
        <title><?php echo lang('app.title_page_prestations')?> | <?php echo $settings['meta_title']?></title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0"><?php echo lang('app.title_page_prestations')?></h4>
...
echo form_open(base_url('admin/prestations'), $attributes);?>
										<div class="col-12">
											...
											<div class="col-12">
                                                  <label class="visually-hidden" for="specificSizeInputName"><?php echo  lang('app.field_prestations')?></label>
                                                  <select name="search_prestations" class="form-control select2" id="specificSizeInputName" data-placeholder="<?php echo  lang('app.field_speciality')?>" >
												  <option value=""></option>
												  <?php if(!empty($list_speciality)){
										foreach($list_speciality as $k=>$v){?>
											<option value="<?php echo $v['id']?>" <?php if($v['id']==($search_prestations ?? '')) echo 'selected' ?>><?php echo $v['title']?></option>
									<?php }}?>
												  </select>
                                            </div>
											<div class="col-12">
			...
			<div class="modal-dialog modal-dialog-scrollable modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						 ...
						 <h5 class="modal-title mt-0" id="exampleModalScrollableTitle"><?php echo lang('app.modal_new_prestations')?></h5>
...
<input type="hidden" name="action" value="edit">
			...
			<div class="modal-dialog modal-dialog-scrollable modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						 ...
						 <h5 class="modal-title mt-0" id="exampleModalScrollableTitle"><?php echo lang('app.modal_update_prestations')?></h5>
						  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
       ...
       <?php $attributes = ['class' => 'form-input-flat', 'id' => 'myform','method'=>'post'];
		echo form_open( base_url($prefix_route.'prestations'), $attributes);?>
			...
			<div class="modal-dialog modal-dialog-scrollable">
				<div class="modal-content">
					<div class="modal-header">
						 ...
						 <h5 class="modal-title mt-0" id="exampleModalScrollableTitle"><?php echo lang('app.modal_delete_prestations')?></h5>
					...
					<div class="modal-body" id="">
						<?php  echo lang('app.alert_msg_delete_prestations')?>
					</div>
					<div class="modal-footer">
						 <button type="button" class="btn btn-light" data-bs-dismiss="modal"><?php echo lang('app.btn_close')?></button>
...
<script>
	...
	function get_data(id){ 
        ...
        var csrfHash = $("meta[name="+csrfName+"]").attr('content'); // CSRF hash
			...
			$.ajax({  
				url:"<?php echo base_url()?>/admin/prestations/update",				
				type: 'post',
