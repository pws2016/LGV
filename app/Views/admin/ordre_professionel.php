...
<html lang="it">
    <head>
        <meta charset="utf-8" />
        <title><?php echo lang('app.title_page_ordre_prof')?> | <?php echo $settings['meta_title']?></title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0"><?php echo lang('app.title_page_ordre_prof')?></h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"><?php echo lang('app.menu_crm')?></a></li>
                                           
											
											  <li class="breadcrumb-item active"><?php echo lang('app.menu_ordre_prof')?></li>
                                        </ol>
                                    </div>
...
echo form_open(base_url('admin/ordreProf'), $attributes);?>
										<div class="col-12">
			...
			<div class="modal-dialog modal-dialog-scrollable modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						 ...
						 <h5 class="modal-title mt-0" id="exampleModalScrollableTitle"><?php echo lang('app.title_page_ordre_prof')?></h5>
...
<input type="hidden" name="action" value="edit">
			...
			<div class="modal-dialog modal-dialog-scrollable modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						 ...
						 <h5 class="modal-title mt-0" id="exampleModalScrollableTitle"><?php echo lang('app.modal_update_ordre_prof')?></h5>
						  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
       ...
       <?php $attributes = ['class' => 'form-input-flat', 'id' => 'myform','method'=>'post'];
		echo form_open( base_url($prefix_route.'ordreProf'), $attributes);?>
			...
			<div class="modal-dialog modal-dialog-scrollable">
				<div class="modal-content">
					<div class="modal-header">
						 ...
						 <h5 class="modal-title mt-0" id="exampleModalScrollableTitle"><?php echo lang('app.modal_delete_ordre_prof')?></h5>
...
<script>
	...
	function get_data(id){ 
        ...
        var csrfHash = $("meta[name="+csrfName+"]").attr('content'); // CSRF hash
			...
			$.ajax({  
				url:"<?php echo base_url()?>/admin/ordreProf/update",				
				type: 'post',
